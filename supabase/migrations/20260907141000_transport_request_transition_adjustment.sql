-- Allow the confirmed application path where Transport creates a high-value service
-- and moves the request directly from MENUNGGU_TRANSPORT to MENUNGGU_APPROVAL.
