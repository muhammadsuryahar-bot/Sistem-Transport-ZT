    ...
    try {
      ...
      if (activePage === 'kendaraan') {
        ...
        exportToExcel(`Rekap-Kendaraan-ZT-${stamp}.xls`, [
          { title: 'KENDARAAN', columns: columns([['kode_kendaraan','Kode Kendaraan'],['nomor_polisi','Nomor Polisi'],['merk','Merk'],['tipe','Tipe'],['jenis_kendaraan','Jenis Kendaraan'],['tahun','Tahun'],['warna','Warna'],['nomor_rangka','Nomor Rangka'],['nomor_mesin','Nomor Mesin'],['status_pajak','Status Pajak'],['unit_kerja','Unit Kerja'],['catatan_hutang','Catatan Hutang'],['kepemilikan','Kepemilikan'],['jenis_sewa','Jenis Sewa'],['pemilik','Pemilik / PIC'],['driver','Driver'],['lokasi','Lokasi'],['unit_kerja','Unit Kerja'],['masa_berlaku_pajak','Masa Berlaku Pajak'],['status_pajak','Status Pajak'],['catatan_hutang','Catatan Hutang'],['kilometer_terakhir','KM Terakhir'],['status','Status'],['kondisi','Kondisi'],['keterangan','Keterangan']]), rows: cleanRows(v.data || []).map(x => ({ ...x, driver: driverMap[x.driver_id]?.nama_lengkap || '-' })) },
