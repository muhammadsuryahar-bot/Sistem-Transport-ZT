    ...
    try {
      ...
      if (activePage === 'kendaraan') {
        ...
        exportToExcel(`Rekap-Rental-ZT-${stamp}.xls`, [
          { title: 'KENDARAAN SEWA', columns: columns([['no','No'],['nomor_polisi','No. Polisi'],['merk','Merk'],['tipe','Type'],['pemilik','Pemilik'],['perusahaan','Perusahaan/Rental'],['lokasi','Lokasi'],['unit_kerja','Unit Kerja'],['nomor_kontrak','No. Kontrak'],['tanggal_mulai','Tanggal Mulai'],['tanggal_selesai','Tanggal Selesai'],['nilai_sewa_bulanan','Sewa Bulanan'],['status_kontrak','Status Kontrak']]), rows: rentalVehicleRows },
