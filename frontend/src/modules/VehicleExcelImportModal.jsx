...
export default function VehicleExcelImportModal({ profile, onDone, onClose }) {
  ...
  const scan = async (nextFile) => {
    ...
    if (nextFile.size > 10 * 1024 * 1024) return setError('Ukuran file maksimal 10 MB.')
    setLoading(true)
    try {
