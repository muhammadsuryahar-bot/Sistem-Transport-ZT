...
export default function ServiceFeaturePage({ profile }) {
  ...
  const tabs = canProcess
    ? [['excel', 'Riwayat Excel'], ['pekerjaan', 'Pekerjaan'], ['item', 'Item Service'], ['bukti', 'Bukti'], ['ban', 'Riwayat Ban'], ['aki', 'Riwayat Aki'], ['km', 'Riwayat KM']]
