...
export default function PermintaanServicePage({ profile }) {
  ...
  const openCreate = (vehicleId = '') => { setForm({ ...EMPTY, kendaraan_id: vehicleId ? String(vehicleId) : '' }); setShowForm(true); setDetail(null); setError(''); setSuccess('') }
